function ToggleFullScreen() {
		...
		var buildUrl = "Build";
		var loaderUrl = buildUrl + "/Shape_Shift.loader.js";
		var config = {
        dataUrl: buildUrl + "/Shape_Shift.data",
        frameworkUrl: buildUrl + "/Shape_Shift.framework.js",
        codeUrl: buildUrl + "/Shape_Shift.wasm",
        streamingAssetsUrl: "StreamingAssets",
        companyName: "Gamebol",
        productName: "Shape Shift",
        productVersion: "1",
      };
